        ...
        <div class="row ">
                    ...
                    <div class="panel panel-default menu-first">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" >
                            <ul class="nav nav-list menu-second">
                                <li class="menu-second-selected"><a href="AllUsers"><i class="icon-user"></i> 用户信息</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="panel panel-default menu-first">
            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <tbody>
                    <s:iterator status="s" var="o" value="#request.messages">
                    <c:set var="a" value="${s.getIndex()}"></c:set>
                    <form action="ModifyMessage" method="post">
                    <tr>
                        <td>${o.getMessageOwner() }</td>
                        <input type="hidden" name="messageOwner" value="${o.getMessageOwner() }">
                        <input type="hidden" name="oldMessage" value="${o.getMessage() }">
                        <td><input type="text" name="message" value="${o.getMessage() }"></td>
                        <td><input type="text" name="response" value="${o.getResponse() }"></td>
                        <td>
                            <input type="submit" value="修改" class="btn btn-primary btn-sm">
                            <a href="AllMessages" class="btn btn-primary btn-sm">返回</a>
                        </td>
                    </form>
                    </tr>
                    </s:iterator>
