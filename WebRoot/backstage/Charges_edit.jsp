            ...
            <div class="col-xs-2 bg-blue">
                ...
                <div class="panel-group sidebar-menu" id="accordion" aria-multiselectable="true">
                    <div class="panel panel-default menu-first menu-first-active">
                        <a href="home.jsp" aria-expanded="true"
                    ...
                    <div class="panel panel-default menu-first">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse">
                            <ul class="nav nav-list menu-second">
                                <li class="menu-second-selected"><a href="AllCharges"><i class="icon-user"></i>订单信息</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="panel panel-default menu-first">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse">
                            <ul class="nav nav-list menu-second">
                                ...
                                <li><a href="AllNews"><i class="icon-edit"></i>新闻管理</a></li>
            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <tr class="info">
                        ...
                        <th class="text-center">租车用户</th>
                        <th class="text-center">租车日期</th>
                        <th class="text-center">还车日期</th>
                        <th class="text-center">租车地点</th>
                    </tr>
                    </thead>
                    <tbody>
                    <s:iterator status="s" var="o" value="#request.Charges">
                    <c:set var="a" value="${s.getIndex() }"></c:set>
                    <form action="UpdateCharges">
                    <tr>
                        <td>${o.getCarID() }</td>
                        <td>${o.getUserName() }</td>
                        <td><input name="rantedDay" value=${o.getRantedDay() }></td>
                        <td><input name="circulateDay" value=${o.getCirculateDay() }></td>
                        <td><input name="rentedplace" value=${o.getRentedplace() } ></td>
                        <td>
                        <input type="hidden" name="carID" value=${o.getCarID() } > 
                        <input type="hidden" name= "userName" value=${o.getUserName() }>                 
                            ...
                            <a href="AllCharges" class="btn btn-primary btn-sm">返回</a>
                        </td>
                        </form>
