        ...
        <div class="row ">
            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <form action="ModifyCarInfo" method="post">
                    <tr>
                        <td>${o.getCarID() }</td>
                        <input type="hidden" name="carID" value="${o.getCarID() }">
                        <td><input type="text" name="carName" value="${o.getCarName() }"></td>
                        <td><input type="text" name="price" value="${o.getPrice() }"></td>
                        <td><input type="text" name="isRented" value="${o.getIsRented() }"></td>
                        <td>
                            ...
                            <a href="AllCars" class="btn btn-primary btn-sm">返回</a>
                        </td>
                    </form>
                    </tr>
                    </s:iterator>
