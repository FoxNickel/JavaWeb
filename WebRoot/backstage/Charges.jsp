            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <tr>
                        <td>${o.getCarID() }</td>
                        <td>${o.getUserName() }</td>
                        <td>${o.getRantedDay() }</td>
                        <td>${o.getCirculateDay() }</td>
                        <td>${o.getRentedplace() } </td>
                        <td>
                        <form action="DeleteCharges">
                         <a href="EditCharges" class="btn btn-primary btn-sm">编辑</a>   
                           <input type="submit" value="删除" class="btn btn-primary btn-sm">
                           <input type="hidden" name="userName" value="${Charges[a].getUserName()}">
                           <input type="hidden" name="carID" value="${Charges[a].getCarID()}">
                        	</form>
                        </td>
                    </tr>
                    </s:iterator>
