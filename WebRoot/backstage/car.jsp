                ...
                <div class="panel-group sidebar-menu" id="accordion" aria-multiselectable="true">
                    ...
                    <div class="panel panel-default menu-first">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse">
                            <ul class="nav nav-list menu-second">
                                <li class="menu-second-selected"><a href="AllCars"><i class="icon-trash"></i>车辆管理</a></li>
            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <tr class="info">
                        ...
                        <th class="text-center">租用情况</th>
                    </tr>
                    </thead>
                    <tbody>
                    <s:iterator status="s" var="o" value="#request.cars">
                    <c:set var="a" value="${s.getIndex() }"></c:set>
                    <tr>
                        <td>${o.getCarID() }</td>
                        <td>${o.getCarName() }</td>
                        <td>${o.getPrice() }</td>
                        <td><c:if test="${!o.getIsRented() }">未租</c:if><c:if test="${o.getIsRented() }">已租</c:if></td>
                        <td>
                        	<a href="car_add.jsp" class="btn btn-primary btn-sm">添加</a>
                            <a href="CarInfoEdit" class="btn btn-primary btn-sm">编辑</a>
                            <a href="DeleteCar?carID=${cars[a].getCarID() }" class="btn btn-primary btn-sm" >删除</a>
                        </td>
                    </tr>
                    </s:iterator>
                    </tbody>
