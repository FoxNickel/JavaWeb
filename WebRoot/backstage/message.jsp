            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <tr>
                        ...
                        <td>${o.getResponse() }</td>
                        <td>
                            <a href="MessageEdit" class="btn btn-primary btn-sm">编辑</a>
                            <a href="DeleteMessage?messageOwner=${messages[a].getMessageOwner() }&message=${messages[a].getMessage() }" class="btn btn-primary btn-sm" >删除</a>
                        </td>
                    </tr>
                    </s:iterator>
                    </tbody>
