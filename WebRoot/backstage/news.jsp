            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <tr>
                        ...
                        <td>${o.getContent() }</td>
                        <td>
                        	<a href="news_add.jsp" class="btn btn-primary btn-sm">添加</a>
                            <a href="NewsEdit" class="btn btn-primary btn-sm">编辑</a>
                            <a href="DeleteNews?id=${news[a].getId() }" class="btn btn-primary btn-sm" >删除</a>
                        </td>
                    </tr>
                    </s:iterator>
                    </tbody>
