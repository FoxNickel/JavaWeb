        ...
        <div class="row ">
            ...
            <div class="col-xs-10">
                ...
                <table class="table table-bordered table-striped text-center bg-info">
                    ...
                    <tbody>
                    <s:iterator status="s" var="o" value="#request.users">
                    <c:set var="a" value="${s.getIndex()}"></c:set>
                    <form action="ModifyUserInfo" method="post">
                    <tr>
                        <td>${o.getUserName() }</td>
                        <input type="hidden" name="user.userName" value="${o.getUserName() }">
                        <td><input type="text" name="user.realName" value="${o.getRealName() }"></td>
                        <td><input type="text" name="user.tel" value="${o.getTel() }"></td>
                        <td><input type="text" name="user.email" value="${o.getEmail() }"></td>
                        <td>
                            ...
                            <a href="AllUsers" class="btn btn-primary btn-sm">返回</a>
                        </td>
                    </form>
                    </tr>
                    </s:iterator>
