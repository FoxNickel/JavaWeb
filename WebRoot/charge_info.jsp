        ...
        <div class="wrap">
            <div class="about">
                <div class="section group">
                        ...
                        <p><font color="#ffffff" size="6">租车信息:</font></p><br>
                        <p><font color="#ffffff">所租车号：${carID }</font></p><br>
                        <p><font color="#ffffff">租赁时间：${rantedDay }</font></p><br>
                        <p><font color="#ffffff">归还时间：${circulateDay }</font></p><br>
                        <p><font color="#ffffff">借车地点：${rentedplace }</font></p><br>
                </div>
            </div>
        </div>
    </div>
